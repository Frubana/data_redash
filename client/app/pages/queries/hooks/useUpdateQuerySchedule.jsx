import { isNil, isObject, extend, keys, omit, pick, uniq, get } from "lodash";
...
function doSaveQuerySchedule(data, { canOverwrite = false } = {}) {
  return Query.saveSchedule(data).catch(error => {
...
export default function useUpdateQuerySchedule(query, onChange) {
  ...
  return useCallback(
    (data = null, { successMessage = "Query saved" } = {}) => {
      ...
      return doSaveQuerySchedule(data, { canOverwrite: policy.canEdit(query) })
        .then(updatedQuery => {
